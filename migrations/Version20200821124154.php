 ...
 */
final class Version20200821124154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, user_course_id INT DEFAULT NULL, course_type_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, name VARCHAR(150) NOT NULL, description VARCHAR(255) DEFAULT NULL, min_person INT DEFAULT NULL, max_person INT DEFAULT NULL, price_ce DOUBLE PRECISION DEFAULT NULL, duration DOUBLE PRECISION NOT NULL, photo VARCHAR(255) NOT NULL, alt VARCHAR(100) NOT NULL, INDEX IDX_169E6FB959FC4476 (user_course_id), INDEX IDX_169E6FB9CD8F897F (course_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
